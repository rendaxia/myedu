                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">修改体验课程</div>
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form" id="qform" method="post" enctype="multipart/form-data" action="/test/Admin/AdminSetOneFreelisten" >

                                <input type="hidden" name = "id" value="${freelisten.id}"/>
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">课程名称
                                        <span class="tpl-form-line-small-title"></span>
                                    </label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="title" class="tpl-form-input" id="user-name" value="${freelisten.title}">
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            ...
                                            <input id="doc-form-file" accept="image/*" onchange="changepic(this)" name="imgurl" type="file" >
                                        </div>
                                        <div  class="am-form-group am-form-file">
