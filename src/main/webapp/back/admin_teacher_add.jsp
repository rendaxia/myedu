                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="/test/Admin/AdminAddOneTeacher" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                ...
                                                <input id="doc-form-file" type="file" accept="image/*" onchange="changepic(this)" name= "tphoto" >
                                            </div>
                                            <div  class="am-form-group am-form-file">
