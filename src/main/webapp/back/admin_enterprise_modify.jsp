            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-nav-link">
                    ...
                    <ul class="sidebar-nav sidebar-nav-sub">
                        ...
                        <li class="sidebar-nav-link">
                            <a href="/Admin/AdminToAddOneLesson">
                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="/test/Admin/AdminSetEnterpriseBasic" id="qform" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div  class="am-u-sm-9">
                                            <div  class="am-form-group am-form-file">
                                                ...
                                                <input id="doc-form-file" accept="image/*" onchange="changepic(this)" type="file" name ="img"  onclick="javascript: _s();">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-10 am-u-sm-push-0">
                                            ...
                                            <button id="btn1"   class="am-btn am-btn-primary tpl-btn-bg-color-success" >修改</button>
                                            ...
                                            <script type="text/javascript">
                                                ...
                                                editor.customConfig.uploadImgServer = '/test/Admin/AdminEnterpriseRichTextImgUpload'
