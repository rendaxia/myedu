                ...
                <div class="row">
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <form  class="am-form tpl-form-line-form"  action="/test/Admin/AdminToShowAllFreelisten" method="post" >
                                            ...
                                            <tr class="gradeX">
                                                ...
                                                <td>
                                                    <div class="tpl-table-black-operation">
                                                        <a href="/test/Admin/AdminToShowOneFreelisten?id=${m.id}">
                                                            <i class="am-icon-eye"></i>
                                                        </a>
                                                        <a href="/test/Admin/AdminToSetOneFreelisten?id=${m.id}">
                                                            <i class="am-icon-pencil"></i>
                                                        </a>
                                                        <a href="/test/Admin/AdminDeleteOneFreelisten?id=${m.id}" class="tpl-table-black-operation-del">
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    ...
                                    <div class="am-fr">
                                        <ul class="am-pagination tpl-pagination">
                                            <li><a href="/test/Admin/AdminToShowAllFreelisten?page=1&branchid=${branchid}">首页</a></li>
                                            <li><a href="/test/Admin/AdminToShowAllFreelisten?page=${p.page-1}&branchid=${branchid}">上一页</a></li>
                                            ...
                                            <c:forEach begin="${p.startPage }" end="${p.endPage }" var="i">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <a href="/test/Admin/AdminToShowAllFreelisten?page=${i }&branchid=${branchid}">${i }</a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:forEach>

                                            <li><a href="/test/Admin/AdminToShowAllFreelisten?page=${p.page+1}&branchid=${branchid}">下一页</a></li>
                                            <li><a href="/test/Admin/AdminToShowAllFreelisten?page=${p.maxPage }&branchid=${branchid}">尾页</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
