                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body  am-fr">
                            ...
                            <form class="am-form tpl-form-line-form"  action="/test/Admin/AdminToShowAllSorderForCAV" method="post">
                                ...
                                <div class="am-u-sm-12 am-u-md-6 am-u-lg-3">
                                    ...
                                    <div class="am-form-group tpl-table-list-select">
                                        ...
                                        <select name="status" data-am-selected="{btnSize: 's'}">
                                            ...
                                            <c:choose>
                                                <c:when test="${status == '已使用'}">
                                                    <option value="已使用" selected>已使用</option>
                                                </c:when>
                                                <c:otherwise>
                                        ...
                                        <tr class="gradeX">
                                            ...
                                            <td>
                                                <div class="tpl-table-black-operation">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${m.status == '已付款'}">
                                                            <a href="/test/Admin/AdminToCAVOneSorder?oid=${m.oid}">
                                                                <i class="am-icon-hand-pointer-o"></i>核销
                                                            </a>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <a href="javascript:;">
                                                                <i class="am-icon-hand-pointer-o"></i>已使用
                                                            </a>
                                                        </c:otherwise>
                                                    </c:choose>
                            ...
                            <div class="am-u-lg-12 am-cf">
                                ...
                                <div class="am-fr">
                                    <ul class="am-pagination tpl-pagination">
                                        <li><a href="/test/Admin/AdminToShowAllSorderForCAV?page=1&lid=${lid}&status=${status}&nickname=${nickname}&startTime=${startTime}&endTime=${endTime}">首页</a></li>
                                        <li><a href="/test/Admin/AdminToShowAllSorderForCAV?page=${p.page-1}&lid=${lid}&status=${status}&nickname=${nickname}&startTime=${startTime}&endTime=${endTime}">上一页</a></li>
                                        ...
                                        <c:forEach begin="${p.startPage }" end="${p.endPage }" var="i">
                                            ...
                                            <c:choose>
                                                ...
                                                <c:otherwise>
                                                    <a href="/test/Admin/AdminToShowAllSorderForCAV?page=${i }&lid=${lid}&status=${status}&nickname=${nickname}&startTime=${startTime}&endTime=${endTime}">${i }</a>
                                                </c:otherwise>
                                            </c:choose>
                                        </c:forEach>

                                        <li><a href="/test/Admin/AdminToShowAllSorderForCAV?page=${p.page+1}&lid=${lid}&status=${status}&nickname=${nickname}&startTime=${startTime}&endTime=${endTime}">下一页</a></li>
                                        <li><a href="/test/Admin/AdminToShowAllSorderForCAV?page=${p.maxPage }&lid=${lid}&status=${status}&nickname=${nickname}&startTime=${startTime}&endTime=${endTime}">尾页</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
