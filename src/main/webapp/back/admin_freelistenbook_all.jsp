                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body  am-fr">
                                ...
                                <form class="am-form tpl-form-line-form"  action="/AdminToShowAllFreelistenbook" method="post">
                                                    ...
                                                    <div class="tpl-table-black-operation">
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${m.status == '待处理'}">
                                                                <a href="/AdminToConfirmOneFreelistenbook?id=${m.id}">
                                ...
                                <div class="am-u-lg-12 am-cf">
                                    ...
                                    <div class="am-fr">
                                        <ul class="am-pagination tpl-pagination">
                                            <li><a href="/AdminToShowAllFreelistenbook?page=1&fid=${fid}&status=${status}&username=${username}&startTime=${startTime}&endTime=${endTime}">首页</a></li>
                                            <li><a href="/AdminToShowAllFreelistenbook?page=${p.page-1}&fid=${fid}&status=${status}&username=${username}&startTime=${startTime}&endTime=${endTime}">上一页</a></li>
                                            ...
                                            <c:forEach begin="${p.startPage }" end="${p.endPage }" var="i">
                                                ...
                                                <c:choose>
                                                    ...
                                                    <c:otherwise>
                                                        <a href="/AdminToShowAllFreelistenbook?page=${i }&fid=${fid}&status=${status}&username=${username}&startTime=${startTime}&endTime=${endTime}">${i }</a>
                                                    </c:otherwise>
                                                </c:choose>
                                            </c:forEach>

                                            <li><a href="/AdminToShowAllFreelistenbook?page=${p.page+1}&fid=${fid}&status=${status}&username=${username}&startTime=${startTime}&endTime=${endTime}">下一页</a></li>
                                            <li><a href="/AdminToShowAllFreelistenbook?page=${p.maxPage }&fid=${fid}&status=${status}&username=${username}&startTime=${startTime}&endTime=${endTime}">尾页</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
