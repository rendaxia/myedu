                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="/test/Admin/AdminAddOneMessage" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                ...
                                                <input id="doc-form-file" name="files" accept="image/*" onchange="changepic(this)" type="file" multiple="multiple">
                                            </div>
                                            <div  class="am-form-group am-form-file">
