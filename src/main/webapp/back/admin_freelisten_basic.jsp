...
<head>
    ...
    <style>
        .fdesc img {width:200px;height:100px;}
    </style>
</head>
        ...
        <ul class="sidebar-nav">
            ...
            <li class="sidebar-nav-link">
                ...
                <ul class="sidebar-nav sidebar-nav-sub">
                    ...
                    <li class="sidebar-nav-link">
                        <a href="/Admin/AdminToShowAllSorderForRefund">
                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        <div class="widget-head am-cf">
                            <div class="widget-title am-fl">体验课程信息展示</div>
                            ...
                            <form class="am-form tpl-form-line-form">
                                    ...
                                    <div class="am-u-sm-9">
                                        <div class="am-form-group am-form-file">
                                            <div class="tpl-form-file-img">
                                                <img src="<%=imgPath%>${freelisten.imgurl}" style="width:600px;height: 400px"  alt="">
                                            </div>
                                ...
                                <div class="am-form-group">
                                    <div class="am-u-sm-9 am-u-sm-push-3">
                                        <a href="/test/Admin/AdminToSetOneFreelisten?id=${freelisten.id}"  type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success ">修改</a>
                                    </div>
                                </div>
