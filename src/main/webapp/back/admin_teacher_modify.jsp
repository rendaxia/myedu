                    ...
                    <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                        <div class="widget am-cf">
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">修改讲师信息</div>
                            ...
                            <div class="widget-body am-fr">
                                ...
                                <form class="am-form tpl-form-line-form" action="/test/Admin/AdminSetOneTeacher" method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="tid" class="tpl-form-input" id="user-name" value="${teacher.tid}">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input" name="tname" id="user-name" value="${teacher.tname}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <div class="am-form-group am-form-file">
                                                ...
                                                <input id="doc-form-file" name="tphoto" accept="image/*" onchange="changepic(this)" type="file">
                                            </div>
                                            <div  class="am-form-group am-form-file">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <textarea class="" rows="10" id="user-intro" name="introduction" >${teacher.introduction}</textarea>
                                        </div>
                                    </div>
