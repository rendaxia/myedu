                ...
                <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                    <div class="widget am-cf">
                        ...
                        <div class="widget-body am-fr">
                            ...
                            <form class="am-form tpl-form-line-form" id="qform" method="post" enctype="multipart/form-data" action="/test/Admin/AdminAddOneFreelisten" >
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10 am-u-sm-push-0">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            editor.customConfig.uploadImgServer = '/test/Admin/AdminFreelistenRichTextImgUpload'
